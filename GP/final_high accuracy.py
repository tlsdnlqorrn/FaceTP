...
while True:
    ...
    for face in detections:
        ...
        if text_eye == "EYE: closed" or text_eye == "":
            cv2.putText(show, "EYE: closed", (15, 80), cv2.FONT_HERSHEY_DUPLEX, 0.8, (10, 10, 230), 2)
    ...
    if results.multi_face_landmarks:
        ...
        cv2.putText(show, "score_eye: " + str(round(score_eye, 2)), (15, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (150, 60, 30), 2)
        cv2.putText(show, "score_face: " + str(round(score_face, 2)), (15, 320), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (150, 60, 30), 2)
